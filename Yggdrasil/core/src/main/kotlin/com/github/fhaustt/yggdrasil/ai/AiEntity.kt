...
data class AiEntity (
    ...
    private val physicsCmps: ComponentMapper<PhysicsComponent> = world.mapper(),
    ...
    val position : Vector2
        get() = physicsCmps[entity].body.position

    val wantsToWalk:Boolean
        get(){
    ...
    fun canAttack() : Boolean{
        ...
        val enemyPhysicCmp = physicsCmps[enemy]
